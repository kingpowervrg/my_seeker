...
namespace EngineCore
{
	public class JsonUtil
	{
        ...
        {
            JSON.RegisterCustomType(typeof(UnityEngine.Vector3), Vector3Jason.SerilizeVector3, Vector3Jason.DserializeVector3);
            JSON.RegisterCustomType(typeof(UnityEngine.Quaternion), QuaternionJason.SerilizeQuaternion, QuaternionJason.DserializeQuaternion);
        }
