...
namespace BestHTTP
{
    ...
    public sealed class HTTPRequest : IEnumerator, IEnumerator<HTTPRequest>
    {
        ...
        internal void SendOutTo(Stream stream_net)
        {
            try
            {
#if !UNITY_WEBGL || UNITY_EDITOR
                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    if (UploadStream != null)
                    {
                        bytes_in_memory = stream.ToArray();
                        stream_net.WriteArray(bytes_in_memory);
                        stream_net.Flush();
                    ...
                    if ((data != null && data.Length > 0) || UploadStream != null)
                    {
