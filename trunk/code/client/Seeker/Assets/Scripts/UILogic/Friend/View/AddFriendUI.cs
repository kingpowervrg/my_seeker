...
{
    class AddFriendUI : BaseViewComponet<FriendUILogic>
    {
        ...
        protected override void OnInit()
        {
            ...
            m_recommend_btn = Make<GameImage>("Panel:Button");
        ...
        {
            CurViewLogic().ShowRecommendView(true);
        }
